...
namespace AionMemory
{
    ...
    End Function
        ...
        public static int GetModuleBase(string modulename)
        {
            ...
            //System.Diagnostics.Process HandleP = System.Diagnostics.Process.GetProcessById((int)Memory.OpenProcess(0x1F0FFF, false, getaionhwd()));

            //if ((int)HandleP == 0) HandleP = (IntPtr)getaionhwd();
