...
namespace AngelRead
{
    ...
    public class Target : Entity
    {
        ...
        public uint TARGETPTR_OFFSET = 0;//x639BBC;
        ...
        new public void Update()
        {
            try
            {
                ...
                if (PtrTarget != 0)
                {
                    ...
                    this.HealthHP = Memory.ReadInt(Process.handle, (uint)(PtrEntity + 0xFE4));
                    this.HealthHPMax = Memory.ReadInt(Process.handle, (uint)(PtrEntity + 0xFE8));
