    ...
    public partial class waypointeditor : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            foreach (string newloc in listBox1.Items)
            {
                ...
                wpoint.X = Convert.ToDouble(theitem[0], CultureInfo.InvariantCulture);
                wpoint.Y = Convert.ToDouble(theitem[1], CultureInfo.InvariantCulture);
                wpoint.Z = Convert.ToDouble(theitem[2], CultureInfo.InvariantCulture);
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox1.Checked == true)
            {
                ...
                foreach (cwaypoint wpoint in deathpointlist)
                {
                    ...
                    x = string.Format(CultureInfo.InvariantCulture,"{0:f2}", Convert.ToDouble(wpoint.X, CultureInfo.InvariantCulture));
                    y = string.Format(CultureInfo.InvariantCulture,"{0:f2}", Convert.ToDouble(wpoint.Y, CultureInfo.InvariantCulture));
                    z = string.Format(CultureInfo.InvariantCulture,"{0:f2}", Convert.ToDouble(wpoint.Z, CultureInfo.InvariantCulture));
                    fullstring = x + " | " + y + " | " + z;
                    listBox1.Items.Add(fullstring);
