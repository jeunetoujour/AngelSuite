...
namespace AngelRead
{
    public class Ability
    {
        ...
        //public uint HOTBAR_OFFSET = 0xB4F810;//0xB3C0A0;//0xA66E38;
        ...
        public void MatchHotbar()
        {
            ...
            for (int bars = 0; bars <= 3; bars++)
            {
                ...
                for (int i = 0; i < 12; i++)
                {
                    long caddress = 0xB58530 + thisbar + (i * 0xC); //0xB3C0A0 0xB3A888
                    int skillnum = (int)Memory.ReadUInt(Process.handle,  Process.Modules.Game + (uint)(caddress + 0x4));
        ...
        public void Update()
        {
            ...
            if (PtrAbility != -1  && ((AbilityID < 30002 || AbilityID > 30003) && (AbilityID < 40001 || AbilityID > 40009) && (AbilityID < 50000 || AbilityID > 50005) && (AbilityID < 50007 || AbilityID > 50037)))
            {
                try
                {
                    CooldownLength = (int)Memory.ReadUInt(Process.handle, (uint)(PtrAbility + 0x3c));
                ...
                { }
                //if (AbilityName == "Evasive Boost I") 
