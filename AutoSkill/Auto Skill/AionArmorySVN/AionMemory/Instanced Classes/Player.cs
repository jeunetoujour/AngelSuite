...
namespace AionMemory
{
    ...
    public class Player : Entity
    {
        ...
        new public void Update()
        {
            ...
            this.State = Memory.ReadInt(Process.handle, (PtrEntity + 0x20C));
            this.TargetID = Memory.ReadInt(Process.handle, (Process.Modules.Game + 0x4F6900));
            this.TargetPtr = Memory.ReadInt(Process.handle, (Process.Modules.Game + 0x4F68FC));
