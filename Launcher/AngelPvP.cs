...
{
    public partial class AngelPvP : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (ents.Type == eType.AttackableNPC && ents.Name != "" && ents.Health > 0 && ents.Distance3D(pc.X,pc.Y,pc.Z) <= 105)
                {            
                        if (ents.Attitude == eAttitude.Passive && ents._Type18 == 1 )
                        {
                            listBox1.Items.Add("(" + ents.Level + ")" + ents.Name + " HP:" + ents.Health + "% " + " D:" + string.Format("{0:f2}", ents.Distance2D(pc.X, pc.Y)));
                        }
