...
namespace ByteSigScanExample
{
    public partial class Form1 : Form
    {
        ...
        string playerInfoSig = "5268XXXXXXXX8d43??";//"5268XXXXXXXX8d4336";
        string abilityinfo = "a1XXXXXXXX50893d??";//"a1XXXXXXXX50893d14????????????2200";
            //"a1XXXXXXXX8b88380100008b903c0100008b83000500008b30bf1cbf0d";
        ...
        string hotbarinfo = "8DB8XXXXXXXX85FF????????????8B47??";//8DB8XXXXXXXX85FF????????????8B47??8B4F??8B17505152";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            const uint PLAYER_LVL_OFFSET = 24; //checked
            const uint PLAYER_EXPLVL_OFFSET = 32; //checked
            const uint PLAYER_EXP_OFFSET = 48; //checked
            const uint PLAYER_MAXHP_OFFSET = 60; //checked
            const uint PLAYER_HP_OFFSET = 64; //checked
            const uint PLAYER_MAXMP_OFFSET = 68; //checked
            const uint PLAYER_MP_OFFSET = 72; //checked
            const uint PLAYER_BAGSLOTS_OFFSET = 148; //wrong x20
            const uint PLAYER_CLASS_OFFSET = 164; //wrong
            ...
            ReadProcessMemory(hProc, gamedll + 0xB04A78 + PLAYER_MP_OFFSET, ref MP, 4, 0);
            

            ReadProcessMemory(hProc, playerInfoAddress + PLAYER_MAXMP_OFFSET, ref MaxMP, 4, 0);

            //ReadProcessMemory(hProc, playerInfoAddress + PLAYER_NAME_OFFSET, ref name, 4, 0);
            //ReadProcessMemory(hProc, playerInfoAddress + PLAYER_MAXMP_OFFSET, ref MaxMP, 4, 0);
            //ReadProcessMemory(hProc, playerInfoAddress + PLAYER_MAXMP_OFFSET, ref MaxMP, 4, 0);
            //ReadProcessMemory(hProc, playerInfoAddress + PLAYER_MAXMP_OFFSET, ref MaxMP, 4, 0);
            //ReadProcessMemory(hProc, playerInfoAddress + PLAYER_MAXMP_OFFSET, ref MaxMP, 4, 0);
