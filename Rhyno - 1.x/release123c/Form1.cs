...
namespace AngelBot
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void healcast(int index)
        {
            double healthpercentage = Convert.ToDouble(pc.Health) / Convert.ToDouble(pc.MaxHealth) * 100;
            ...
            while ((prevhealth >= pc.Health) && (numtries < 10))
            {
                numtries++;
        ...
        private void mainattackloop(int sequenceindex)
        {
        ...
        private void rest()
        {
            ...
            try
            {
                ...
                if (pc.Health < pc.MaxHealth) healcast(getLightestHeal());
            ...
            if (pc.Health == 0)
            {
                ...
                if (deathpointlist.Count >= 1)
                {
                    ...
                    while (sitcounter < deathresttime)
                    {
                        ...
                        Application.DoEvents();
                        if (findpcstance() == eStance.Normal) keyenumerator(keyrest);
                        if (btnstop.Visible == false) break;
        ...
        public void changewaypoint()
        {
            if (deathrun == true)
            {
                if (pc.Distance3D(awaypoint.X, awaypoint.Y, awaypoint.Z) < 2.8) //hit waypoint CHANGE THIS
                {
                    deathcounter++;
                }
