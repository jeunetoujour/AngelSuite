...
namespace AngelBot
{
    ...
    public partial class Form1 : Form
    {
        ...
        DateTime[] bufftimes = new DateTime[5];
        TimeSpan[] buffdelays = new TimeSpan[5];
        ...
        public void clearsettings()
        {
            ...
            attacks.Clear();
            buffs.Clear();
            buffdelays = new TimeSpan[5];
            bufftimes = new DateTime[5];
        ...
        private void buffload()
        {
            ...
            foreach (string buff in buffs)
            {
                ...
                buffdelays[counter] = new TimeSpan(delay + 1000);
                bufftimes[counter] = DateTime.Now;
        ...
        public void gettarptr()
        {
            EntityList elist = new EntityList();
            elist.Update();
            lblstatus.Text = "Status: Getting Player's Target's Entity";
            Application.DoEvents();
